...
public class NaturalNumberOrderer extends Problem implements IProblem
{
			...
			throws Exception
	{
		...
		INaturalNumber C = new NaturalNumber(
				"NaturalNumberOrderer-" + nNOCount++);
		IProblem p1 = new NaturalNumberAdder(X,
				new NaturalNumber("NaturalNumberOrderer-" + nNOCount++), Y, C);
		// Constrain overflow bit
		IProblem p2 = new BitFixer(
	...
	{
		INaturalNumber dummy = new NaturalNumber(
				"NaturalNumberOrderer-" + nNOCount++);
